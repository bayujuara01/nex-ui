...
import { RichTextEditor as MantineRichTextEditor } from '@nex-ui/tiptap';
...
import { useRichTextEditorContext } from '@nex-ui/tiptap';
...
```tsx
import { RichTextEditorLabels } from '@nex-ui/tiptap';
