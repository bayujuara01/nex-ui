...
```tsx
import { Combobox, useCombobox } from '@nex-ui/core';
...
```tsx
import type { UseComboboxOptions } from '@nex-ui/core';
```
...
```tsx
import type { ComboboxStore } from '@nex-ui/core';
```
...
```tsx
import { Button, Combobox, useCombobox } from '@nex-ui/core';
