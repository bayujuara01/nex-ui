...
If you prefer old colors, change theme settings on `NexProvider`:
...
- `@mantine/ds` package has been deprecated. You can use `@mantinex/nex-ui-logo` package to use `MantineLogo` component in your project.
