...
```tsx
import '@nex-ui/core/styles/UnstyledButton.css';
import '@nex-ui/core/styles/Button.css';
```
...
```tsx
import '@nex-ui/core/styles/ScrollArea.css';
import '@nex-ui/core/styles/UnstyledButton.css';
import '@nex-ui/core/styles/VisuallyHidden.css';
import '@nex-ui/core/styles/Paper.css';
import '@nex-ui/core/styles/Popover.css';
import '@nex-ui/core/styles/CloseButton.css';
import '@nex-ui/core/styles/Group.css';
import '@nex-ui/core/styles/Loader.css';
import '@nex-ui/core/styles/Overlay.css';
import '@nex-ui/core/styles/ModalBase.css';
import '@nex-ui/core/styles/Input.css';
import '@nex-ui/core/styles/InlineInput.css';
import '@nex-ui/core/styles/Flex.css';
import '@nex-ui/core/styles/FloatingIndicator.css';
```
...
```tsx
import '@nex-ui/core/styles/global.css';
```
