...
```tsx
import { Button, createTheme, NexProvider } from '@nex-ui/core';
...
The prefix of static classes can be changed with `classNamesPrefix` of [NexProvider](/theming/mantine-provider#classnamesprefix).
