...
import classes from './NexTableHeadCellSortLabel.module.css';
...
import type { NexTableHeader, NexRowData, NexTableTableInstance } from '../../types';
...
export const NexTableHeadCellSortLabel = <TData extends NexRowData>({
  header,
  table,
  ...rest
}: Props<TData>) => {
