import classes from './NexTableFilterOptionMenu.module.css';
...
import {
  ...
  type NexTableHeader,
  type NexTableInternalFilterOption,
...
export const NexTableFilterOptionMenu = <TData extends NexRowData>({
  header,
  onSelect,
  table,
}: Props<TData>) => {
  ...
  const handleSelectFilterMode = (option: NexTableFilterOption) => {
    ...
    if (!header || !column) {
      ...
      if (emptyModes.includes(option)) {
        ...
        rangeModes.includes(option as NexTableFilterOption)
      ) {
          ...
          ({ divider, label, option, symbol }, index) => (
            <Fragment key={index}>
              <Menu.Item
                ...
                onClick={() =>
                  handleSelectFilterMode(option as NexTableFilterOption)
                }
                value={option}
              >
                {label}
