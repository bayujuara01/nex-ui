...
import classes from './NexTableFilterRangeSlider.module.css';
...
interface Props<TData extends NexRowData> extends RangeSliderProps {
  header: NexTableHeader<TData>;
  table: NexTableTableInstance<TData>;
}

export const NexTableFilterRangeSlider = <TData extends NexRowData>({
  header,
  table,
  ...rest
}: Props<TData>) => {
