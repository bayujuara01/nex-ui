...
export type { HotkeyItem, HotkeyItemOptions } from './use-hotkeys/use-hotkeys.js';
...
export type { UseStateHistoryHandlers, StateHistory } from './use-state-history/use-state-history.js';
